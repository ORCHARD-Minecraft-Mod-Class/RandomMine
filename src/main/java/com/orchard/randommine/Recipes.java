...
public class Recipes {
	...
	//   });	
		  ...
		  addarmor(EmeraldArmor.helmet,EmeraldArmor.body,EmeraldArmor.legs,EmeraldArmor.boots,Items.emerald);
	}
	static void addarmor(Item hat,Item body,Item leg,Item boot,Object ino){
